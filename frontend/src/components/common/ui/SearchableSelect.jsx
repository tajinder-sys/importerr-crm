  ...
  return (
    <div ref={containerRef} className={cn('relative', className)}>
      ...
      {open && (
        <div
          className={cn(
            'absolute z-20 mt-1 w-full overflow-hidden rounded-md border border-gray-200 bg-white shadow-lg shadow-gray-100/80',
        ...
        >
            ...
            <div className="border-b border-gray-100 p-1.5">
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="Search..."
                  className={cn(
                    'h-7 w-full rounded bg-gray-50 pl-7 pr-2 text-xs text-gray-800 placeholder:text-gray-400',
                    'border border-gray-200 focus:border-violet-400 focus:outline-none focus:ring-1 focus:ring-violet-400/20'
                  )}
                />
              </div>
            </div>
          ...
          <div className="max-h-48 overflow-y-auto p-1 scrollbar-thin">
            {filteredOptions.length === 0 ? (
              <p className="px-2 py-3 text-center text-xs text-gray-400">No results found</p>
            ) : (
