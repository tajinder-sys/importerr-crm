...
const LeadFilters = ({ filters, onFilterChange, onSearchChange, onSearchEnter, onReset, disabled = false }) => (
  <Card className="rounded-xl border-gray-200 shadow-sm">
    <CardContent className="space-y-2 py-2">
      <div className="flex flex-col gap-2 lg:flex-row lg:items-center lg:justify-between">
        <div className="min-w-0 space-y-2">
          <div className="flex items-center gap-2">
            <p className="shrink-0 text-[10px] font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400">Status</p>
          ...
          <div className="flex items-center gap-2">
            <p className="shrink-0 text-[10px] font-semibold uppercase tracking-wide text-gray-500 dark:text-slate-400">Source</p>
            <div className="flex gap-1 overflow-x-auto">
        ...
        <div className="flex items-center gap-2 lg:shrink-0">
          <div className="w-full lg:w-72">
            <Input
              ...
              onKeyDown={(event) => {
                if (event.key === 'Enter') { event.preventDefault(); onSearchEnter(); }
              }}
