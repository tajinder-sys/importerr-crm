          ...
          <div className="rounded-xl border border-slate-200 overflow-hidden">
            ...
            <div className="flex items-center justify-between px-3.5 py-2.5 bg-slate-50 border-b border-slate-100">
              <div className="flex items-center gap-1.5">
                ...
                <p className="text-xs font-semibold text-slate-700">Pricing snapshot</p>
              </div>
                    ...
                    {baseFinalPrice > 0 && baseFinalPrice !== currentFinalPrice && (
                      <div className="flex items-center justify-between px-3 py-2 bg-slate-50/60">
                        ...
                        <div className="text-right">
                          <p className="text-xs text-slate-400 line-through">{formatCurrency(baseFinalPrice)}</p>
                          <p className="text-[9px] text-slate-300">{formatCurrency(baseUnitPrice)} / unit</p>
                        </div>
                      </div>
                    )}
