    ...
    <div className="px-4 py-6 sm:px-6 md:px-8">
      <div className="mx-auto max-w-7xl space-y-6">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Teams Settings</h1>
            <p className="mt-1 text-sm text-gray-500">Manage teams, their members and configurations.</p>
          </div>
          {admin ? (
            <Button
              onClick={() => {
        ...
        <Card className="rounded-2xl border-gray-200 shadow-sm">
          <CardHeader className="border-gray-100">
            <h2 className="text-md font-semibold text-gray-900">Teams</h2>
          </CardHeader>
          <CardContent>
            <Table
